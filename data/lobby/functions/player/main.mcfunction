...
#sub main functions
execute if entity @s[team=lobby,tag=!lobby_editor] run function lobby:player/in_lobby
execute if entity @s[team=!lobby,tag=!lobby_editor] run function lobby:player/in_game
