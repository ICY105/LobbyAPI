...
execute if score game_pos lobby_data matches 1 run setblock ~ 240 ~ minecraft:structure_block[mode=load]{name:"lobby:lobby_sky",posX:-12,posY:0,posZ:-12,mode:"LOAD",integrity:1.0f,showair:0b,showboundingbox:0b}
...
execute if score game_pos lobby_data matches 0 run setblock ~ 1 ~ minecraft:structure_block[mode=load]{name:"lobby:lobby_sky",posX:-12,posY:0,posZ:-12,mode:"LOAD",integrity:1.0f,showair:0b,showboundingbox:0b}
